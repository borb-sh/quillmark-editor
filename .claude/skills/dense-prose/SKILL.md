...
- Collapse padded scaffolding: "## Key Functions / ## Quick Example / ## Detailed Documentation / For comprehensive details including: …" becomes one tight paragraph and at most one runnable example.
...
Present tense. Lead with the invariant or contract, then the mechanism. Reuse the codebase's terms-of-art (*plate, quill, seam, backend, leaf, island, field box*). No em-dashes: fold with a colon, semicolon, comma, or parentheses. Match the density of the exemplars: `src/lib/preview/paint.ts`, `src/lib/core/codec/field.ts`, `prose/canon/PREVIEW.md`.
