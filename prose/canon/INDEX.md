...
- [RELEASE.md](RELEASE.md): independent versions, changesets, and the one gate.
...
- [`packages/studio`](../../packages/studio/prose/canon/INDEX.md): the app that composes them, for an author working on a quill.
